...
| **2. Target SMEs** | We target two groups of European SMEs: <br>1. **Supply-Chain Driven B2B** (clients demand Scope 3 data due to **CSRD**) and <br>2. **GSG-Conscious Growth SMEs** (seeking competitive advantage/investment). | **Commercial Imperative:** Motivation is driven by client demands and market competitiveness, mitigating the risk of relaxed direct EU regulations. |
...
- **Calculate GHG liabilities** based on uploaded data
